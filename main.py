    ...
    try:
        ...
        try:
            ...
            for p in products['hits']:
                ...
                itemArray = {_code: {'name': p['document']['name'], 'sku': _code, 'quantity': _quantity, 'price': p['document']
                                     ['price'], 'image':  p['document']['image'], 'total_price': _quantity * p['document']['price']}}
